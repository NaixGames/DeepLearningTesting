...
if __name__ == "__main__":
  ...
  #Param for each optimizer cycle (we do two to test serialization)
  step = 0.01
  ...
  if load_at_start:
    print("Resuming old train data")
    trainer.load_training_data(net, "TrainerSerializerTest/")

  trainer.train_FFNN_MNIST(net, optimizer, dataset, epochs, batch_size, frequency_loss_print)

  print("Testing serialization")
  print("Saving training data")
  trainer.save_training_data(net, "TrainerSerializerTest/")
  print("Loading training data")
  trainer.load_training_data(net, "TrainerSerializerTest/")

  print("Data should have been saved and loaded. Resuming training.")
  trainer.train_FFNN_MNIST(net, optimizer, dataset, epochs, batch_size, frequency_loss_print)